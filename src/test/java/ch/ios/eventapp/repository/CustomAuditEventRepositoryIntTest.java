...
import ch.ios.eventapp.config.audit.AuditEventConverter;
import ch.ios.eventapp.domain.PersistentAuditEvent;
...
import static ch.ios.eventapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
